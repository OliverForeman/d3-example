...
const Pie = () => {
  ...
  const arcTweenRemove = (_, i) => {
    const end = Object.assign({}, currentAngles[i], { startAngle: graphEnd, endAngle: graphEnd });
    const interpolate = d3.interpolate(currentAngles[i], end);
    return t => arc(interpolate(t));
  };
